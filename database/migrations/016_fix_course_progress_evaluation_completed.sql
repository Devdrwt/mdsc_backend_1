...
-- Le trigger doit vérifier que l'évaluation finale est COMPLÉTÉE (peu importe si réussie ou échouée)
-- avant de mettre la progression à 100%

-- Supprimer l'ancien trigger
DROP TRIGGER IF EXISTS update_course_progress;

-- Créer le nouveau trigger avec la logique corrigée
DELIMITER //
