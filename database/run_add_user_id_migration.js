/**
 * Script pour ajouter user_id et rejection_reason à la table testimonials
 * Usage: node database/run_add_user_id_migration.js
 */
...
async function runMigration() {
  try {
    console.log('🔄 Ajout de user_id et rejection_reason à la table testimonials...\n');

    const migrationFile = path.join(__dirname, 'add_user_id_to_testimonials.sql');
    ...
    console.log('▶️  Exécution de add_user_id_to_testimonials.sql...');
